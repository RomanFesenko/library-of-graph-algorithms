...
dense_prim(const graph_t&graph,
           ...
           filter_t filter=always_bool_t<true>{})
{
    ...
    dense_priority_search(graph,sourse,search,tree,minimize_edge_t<graph_t>{});
    return res;
}
